...
pub trait Visitor {
    ...
    fn visit_method(&mut self, method: &mut Method) {
...
pub fn walk_class<V: Visitor + ?Sized>(v: &mut V, class: &mut Class) {
...
pub fn walk_method<V: Visitor + ?Sized>(v: &mut V, method: &mut Method) {
    for stmt in &mut method.code {
        v.visit_statement(stmt);
    }
}

pub fn walk_field<V: Visitor + ?Sized>(v: &mut V, field: &mut Field) {
