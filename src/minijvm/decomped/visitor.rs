use super::{Class, Method, Field, Statement, Expression};
...
pub fn walk_class<V: Visitor + ?Sized>(v: &mut V, class: &mut Class) -> anyhow::Result<()> {
...
pub fn walk_method<V: Visitor + ?Sized>(v: &mut V, method: &mut Method) -> anyhow::Result<()> {
...
pub fn walk_field<V: Visitor + ?Sized>(v: &mut V, field: &mut Field) -> anyhow::Result<()> {
...
pub fn walk_statement<V: Visitor + ?Sized>(v: &mut V, stmt: &mut Statement) -> anyhow::Result<()> {
    match stmt {
...
pub fn walk_expression<V: Visitor + ?Sized>(v: &mut V, expr: &mut Expression) -> anyhow::Result<()> {
    match expr {
        Expression::Constant { .. }
        | Expression::Load { .. }
        | Expression::LoadTemp { .. }
